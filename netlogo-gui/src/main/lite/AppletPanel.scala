...
with ControlSet {
  ...
  def openFromURI(uri: URI) {
    ...
    val converter = fileformat.converter(workspace.getExtensionManager, workspace.getModuleManager,
      workspace.getCompilationEnvironment, workspace, fileformat.defaultAutoConvertables) _
